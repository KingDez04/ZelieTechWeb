  ...
  return (
    <article className="max-w-[1155px] mx-auto">
      ...
      <p className="text-[12px] md:text-[22px] leading-[100%]">
        Some platforms aren’t just about functionality — they’re about feeling,
        presence, and purpose. When creating a site for a spiritual community,
        it wasn’t enough to simply make it work; it had to resonate. It needed
        to feel calm, clear, and quietly powerful — a digital space that invites
        reflection, connection, and grace. Here’s how we approached building a
        platform that speaks to the soul as much as it serves the user.
      </p>
      <div className="grid grid-cols-2 gap-10 my-5 text-[22px]">
        <div>
          ...
          <p>
            ...
            accessibility. Every color, font, and interaction was chosen to make
            visitors feel at ease, whether they’re looking for a sermon, joining
            a prayer session, or just needing a quiet moment of connection.
          </p>
        </div>
      ...
      <p className="text-[12px] md:text-[22px] text-center">
        ...
        building it reminded us that sometimes, the most powerful design speaks
        softly.
      </p>
    </article>
  );
