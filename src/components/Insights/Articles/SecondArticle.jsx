    ...
    <article className="max-w-[1155px] mx-auto">
      ...
      <div className="my-5">
        <p className="text-[12px] md:text-[22px] text-left">
          ...
          ordering system, added space for seasonal specials, and made sure the
          whole experience worked beautifully on any device.
        </p>
        <p className="text-[12px] md:text-[22px] text-left">
          The result? A warm, simple, and deliciously smooth digital experience
          that still feels like BX Bakes — just online now.
        </p>
      </div>
      <div className="grid grid-cols-2 gap-10">
        <div className="text-[12px] md:text-[22px]">
          ...
          <p className="leading-[100%]">
            That was the question we asked ourselves when BX Bakes reached out.
          </p>
          <p className="leading-[100%]">
      ...
      <div className="grid grid-cols-2 gap-10 my-5 text-[22px]">
        ...
        <div className="text-[12px] md:text-[22px]">
          ...
          <p className="leading-[100%]">
            Before we touched a single design file, we sat down with the BX team
            to understand what made their business tick. The vibe? Warm,
            slightly playful, but still polished. It wasn’t just about pastries
            — it was about memories, celebrations, and that “just one more bite”
            feeling.
          </p>
          <p className="leading-[100%]">
          ...
          <p className="leading-[100%]">
            ...
            homemade warmth with a modern edge. The final logo was a clean serif
            wordmark with a subtle swirl — a nod to frosting, yes, but also
            motion, creativity, and growth.
          </p>
        </div>
      </div>
      <p className="text-[12px] md:text-[22px] text-left">
        The color palette leaned into creamy tones, soft pastels, and rich
        chocolatey browns. Nothing too flashy — just the right amount of flavor.
      </p>
      <div>
        ...
        <ul className="text-[12px] md:text-[22px]">
          ...
          <li>
            • Microinteractions that made clicking feel delicious (yes, we said
            it)
          </li>
        </ul>
        <p className="text-[12px] md:text-[22px] text-left">
        ...
        <p className="text-[12px] md:text-[22px] text-left">
          Designing for food is like designing for feeling. It’s not just about
          showing off pretty images — it’s about creating an experience that
          makes someone feel something before they’ve even placed an order. BX
          Bakes reminded us that even the most traditional businesses can thrive
          online — as long as you stay rooted in what makes you you.
        </p>
      </div>
      <div className="my-5">
        <p className="text-[12px] md:text-[22px] text-left">
