...
const Insights = () => {
  ...
  return (
    <div>
      <div
        className="relative text-white text-center md:text-left h-[416px] bg-cover bg-[70%] md:bg-center"
      ...
      >
        <div className="absolute inset-4 md:inset-20 flex flex-col justify-end md:justify-center items-start">
          <h1
            ...
            className="self-center md:self-auto text-[32px] md:text-[48px] leading-[41.15px] md:leading-[44.78px] font-extrabold mb-2"
          >
            Insights That Drive Innovation
          </h1>
          <p
            style={{ textShadow: "5px 5px 10px #16B4F4" }}
            className="font-extrabold self-center md:self-auto text-[13px] md:text-[14px] leading-[20.57px] md:leading-[26.63px] mb-8 max-w-[483px]"
          >
        ...
        <div className="py-10 flex flex-col gap-5 max-w-[80%] mx-auto">
          <div className="font-light flex gap-5 text-[14px] md:text-[27px] leading-[100%]">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-[10px] md:text-[14px]">
                The behind-the-scenes story of how we turned a bold idea into
                one of the most exciting tech launches of 2025.
              </p>
          ...
          <div className="font-light flex gap-5 text-[14px] md:text-[27px] leading-[100%]">
            ...
            <div className="flex flex-col gap-3 md:gap-10">
              ...
              <p className="text-[8px] md:text-[15px]">
                Creating a serene, functional platform for a spiritual
                community.
              </p>
              <p className="text-[8px] md:text-[15px]">Posted June 2025</p>
              <Link
